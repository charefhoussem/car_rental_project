 ...
 * @author PC
 */
public class administrator_show_customers extends javax.swing.JFrame {
        public administrator_show_customers() {
        initComponents();
        fillJtable();
   ...
   private void fillJtable() {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("the list of customers ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(administrator_show_customers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new administrator_show_customers().setVisible(true);
            }
        });
    }
